...
const ReactDLL = {
  ...
  dllPlugin: {
    defaults: {
      ...
      path: resolve('../node_modules/react-dlls'),
    },

    entry(pkg) {
      const dependencyNames = Object.keys(pkg.dependencies);
      const exclude = pkg.dllPlugin.exclude || ReactDLL.dllPlugin.defaults.exclude;
      const include = pkg.dllPlugin.include || ReactDLL.dllPlugin.defaults.include;
